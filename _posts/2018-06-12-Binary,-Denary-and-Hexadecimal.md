...
My Keen taught us that hexadecimal is in base 16 and since there are no digits bigger than 9 the digits go 0123456789ABCDEF where A - F is 10 - 16.
...
2 digit hexadecimal numbers can (like 8 digit binary numbers) go up to 255 as that is (16 * 15) + (1 * 15). 
